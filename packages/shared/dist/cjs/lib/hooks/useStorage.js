...
exports.useStorageSuspense = useStorageSuspense;
exports.useStorage = useStorage;
var react_1 = require("react");
// eslint-disable-next-line @typescript-eslint/no-explicit-any
var storageMap = new Map();
function useStorageSuspense(storage) {
    var _data = (0, react_1.useSyncExternalStore)(storage.subscribe, storage.getSnapshot);
